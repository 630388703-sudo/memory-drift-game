...
一件为 1080×1920 竖屏装置设计的网页互动实验。观众从“未响应”的生成式粒子信号进入一段记忆：观看同一张图、三次回答同一个问题，并在照片与干扰之间移动。每次回想都会制造一个更强烈的新版本——彩色原图、全黑白档案、紫蓝色重构——最后把问题从“记对了吗”转向“我们是否正在失去遗忘的能力”。
...
3. **介绍与观察**：了解主题，观看包含四个人的最初画面，并记录第一次回答。
